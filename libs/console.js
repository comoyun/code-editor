...
(function(_o) {
  ...
  var checkAll = function checkAll(_param, _param2) {
    return isArray(_param) ? _param.every(function(_val) {
      return (typeof _val === "undefined" ? "undefined" : _typeof(_val)) === _param2;
    }) : (typeof _param === "undefined" ? "undefined" : _typeof(_param)) === _param2 ? true : false;
  };
  var isObject = function isObject(_param) {
    return checkAll(_param, "object");
  };
  var isString = function isString(_param) {
    return checkAll(_param, "string");
  };
  var isNumber = function isNumber(_param) {
